...
const NestedContentTreeNode = styled(({className, location, children, setCollapsed, collapsed}) =>
  //<Slide top>
...
const ContentTreeNode = ({className, toggle, collapsed, url, title, location, children, ...rest}) => {
  ...
  return (
    <>
      ...
      {! isCollapsed ? (
        <NestedContentTreeNode collapsed={collapsed} location={location} setCollapsed={toggle} children={children} />
      ) : null}
    </>
  );
}
